...
/**
 * Generated when a commands is sent over an SMTP connection.
 *
 * @author Chris Corbyn
 */
class Swift_Events_CommandEvent extends Swift_Events_EventObject
{
    ...
    /**
     * Create a new CommandEvent for $source with $commands.
     *
    ...
    /**
     * Get the commands which was sent to the server.
     *
     * @return string
     */
    ...
    /**
     * Get the numeric response codes which indicate success for this commands.
     *
     * @return integer[]
     */
