...
abstract class Swift_Transport_AbstractSmtpTransport implements Swift_Transport
{
    ...
    /** The domain name to use in HELO commands */
    ...
    /**
     * Run a commands against the buffer, expecting the given response codes.
     *
