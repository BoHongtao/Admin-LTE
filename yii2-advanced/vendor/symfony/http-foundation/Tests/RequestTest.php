...
class RequestTest extends TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['REQUEST_URI'] = '/mobile-index.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/mobile-index.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/mobile-index.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/mobile-index.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/mobile-index.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/mobile-index.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/mobile-index.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide mobile-index.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ mobile-index.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/mobile-index.php';
        $server['PHP_SELF'] = '/mobile-index.php';
        $server['SCRIPT_FILENAME'] = '/some/where/mobile-index.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/mobile-index.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/mobile-index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/mobile-index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/mobile-index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/mobile-index.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/mobile-index.php';
        $server['ORIG_SCRIPT_NAME'] = '/mobile-index.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/mobile-index.php',
                    'SCRIPT_NAME' => '/fruit/mobile-index.php',
                    'PHP_SELF' => '/fruit/mobile-index.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/mobile-index.php',
                    'SCRIPT_NAME' => '/mobile-index.php',
                    'PHP_SELF' => '/mobile-index.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
