...
class BaseUrl
{
     ...
     *
     * ```php
     * // generates: /mobile-index.php?r=site/index&param1=value1&param2=value2
     ...
     *
     * ```php
     * // generates: /mobile-index.php?r=site/index&param1=value1#name
     ...
     *
     * ```php
     * // /mobile-index.php?r=site%2Findex
     * echo Url::toRoute('site/index');
     *
     * // /mobile-index.php?r=site%2Findex&src=ref1#name
     ...
     *
     * // /mobile-index.php?r=post%2Findex     assume the alias "@posts" is defined as "post/index"
     ...
     *
     * // /mobile-index.php?r=post%2Fview&id=123&src=google
     * echo Url::current();
     *
     * // /mobile-index.php?r=post%2Fview&id=123
     * echo Url::current(['src' => null]);
     *
     * // /mobile-index.php?r=post%2Fview&id=100&src=google
