...
class BaseFileHelper
{
     ...
     *   For example, "views/*.php" matches "views/mobile-index.php" but not "views/controller/mobile-index.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*.php" matches "mobile-index.php" but not "views/start/mobile-index.php".
