 ...
 * $rows = $query->all();
 * // alternatively, you can create DB commands and execute it
 * $commands = $query->createCommand();
 * // $commands->sql returns the actual SQL
 * $rows = $commands->queryAll();
 * ```
 *
...
class Query extends Component implements QueryInterface
{
    ...
    /**
     * Creates a DB commands that can be used to execute this query.
     * @param Connection $db the database connection used to generate the SQL statement.
     * If this parameter is not given, the `db` application component will be used.
     * @return Command the created DB commands instance.
     */
