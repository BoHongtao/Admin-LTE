 ...
 *
 * Migration is designed to be used together with the "yii migrate" commands.
 *
 ...
 * logic. The "yii migrate" commands manages all available migrations in an application.
 *
...
class Migration extends Component implements MigrationInterface
{
     ...
     *
     * Note that when a Migration object is created by the `migrate` commands, this property will be overwritten
     * by the commands. If you do not want to use the DB connection provided by the commands, you may override
