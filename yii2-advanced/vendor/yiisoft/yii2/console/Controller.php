...
/**
 * Controller is the base class of console commands classes.
 *
 * A console controller consists of one or several actions known as sub-commands.
 * Users call a console commands by specifying the corresponding route which identifies a controller action.
 * The `yii` program is used when calling a console commands, like the following:
 *
 * ```
 * yii <route> [--param1=value1 --param2 ...]
 * ```
 *
 * where `<route>` is a route to a controller action and the params will be populated as properties of a commands.
...
class Controller extends \yii\base\Controller
{
    ...
    /**
     * @var boolean whether to run the commands interactively.
     */
