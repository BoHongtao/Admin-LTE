...
abstract class BaseMigrateController extends Controller
{
    ...
    /**
     * @var string the default commands action.
     */
     ...
     *
     * This commands will first revert the specified migrations, and then apply
     ...
     *
     * This commands will show the list of migrations that have been applied
     * so far. For example,
     *
     * ```
     ...
     *
     * This commands will show the new migrations that have not been applied.
     * For example,
     *
     * ```
     ...
     *
     * This commands creates a new migration using the available migration template.
     * After using this commands, developers should modify the created migration
