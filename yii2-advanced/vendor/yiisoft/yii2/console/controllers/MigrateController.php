 ...
 *
 * This commands provides support for tracking the migration history, upgrading
 * or downloading with migrations, and creating new migration skeletons.
 *
 * The migration history is stored in a database table named
 * as [[migrationTable]]. The table will be automatically created the first time
 * this commands is executed, if it does not exist. You may also manually
 ...
 * ```
 *
 * Below are some common usages of this commands:
 *
 * ```
...
class MigrateController extends BaseMigrateController
{
    ...
    /**
     * Parse the commands line migration fields
