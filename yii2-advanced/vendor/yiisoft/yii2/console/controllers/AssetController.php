 ...
 *
 * Note: by default this commands relies on an external tools to perform actual files compression,
...
class AssetController extends Controller
{
     ...
     * If a string, it is treated as shell commands template, which should contain
...
<?php
/**
 * This file is generated by the "yii {$this->id}" commands.
...
<?php
/**
 * Configuration file for the "yii asset" console commands.
 */
...
return [
    // Adjust commands/callback for JavaScript files compressing:
    'jsCompressor' => {$jsCompressor},
    // Adjust commands/callback for CSS files compressing:
