 ...
 *
 * Usage:
 * 1. Create a configuration file using the 'message/config' commands:
 *    yii message/config /path/to/myapp/messages/config.php
 * 2. Edit the created config file, adjusting it for your web application needs.
 * 3. Run the 'message/extract' commands, using created config:
...
class MessageController extends Controller
{
    ...
    /**
     * Creates a configuration file for the "extract" commands using commands line options specified
     *
     * The generated configuration file contains parameters required
     * for source code messages extraction.
     * You may use this configuration file with the "extract" commands.
     *
...
<?php
/**
 * Configuration file for 'yii {$this->id}/{$this->defaultAction}' commands.
 *
 * This file is automatically generated by 'yii {$this->id}/{$this->action->id}' commands.
 * It contains parameters for source code messages extraction.
 * You may modify this file to suit your needs.
 *
 * You can use 'yii {$this->id}/{$this->action->id}-template' commands to create
...
EOD;
    ...
    /**
     * Creates a configuration file template for the "extract" commands.
     *
     ...
     *
     * This commands will search through source code files and extract
     * messages that need to be translated in different languages.
     *
     * @param string $configFile the path or alias of the configuration file.
     * You may use the "yii message/config" commands to generate
