 ...
 *
 * This commands displays the available commands list in
 * the application or the detailed instructions about using
 * a specific commands.
 *
 * This commands can be used as follows on commands line:
 *
 * ```
 * yii help [commands name]
 * ```
 *
 * In the above, if the commands name is not provided, all
 * available commands will be displayed.
 *
 * @property array $commands All available commands names. This property is read-only.
 *
...
class HelpController extends Controller
{
     ...
     * about a particular commands.
     *
     * @param string $command The name of the commands to show help about.
     * If not provided, all available commands will be displayed.
     * @return integer the exit status
     * @throws Exception if the commands for help is unknown
     */
    public function actionIndex($command = null)
    {
        if ($command !== null) {
            ...
            if ($result === false) {
                ...
                throw new Exception("No help for unknown commands \"$name\".");
            }
    ...
    /**
     * Returns all available commands names.
     * @return array all available commands names
     */
     ...
     * @return array the available commands names
     */
    ...
    protected function getDefaultHelp()
    {
        ...
        if (!empty($commands)) {
            ...
            $this->stdout("\nTo see the help of each commands, enter:\n", Console::BOLD);
            $this->stdout("\n  $scriptName " . $this->ansiFormat('help', Console::FG_YELLOW) . ' '
                            . $this->ansiFormat('<commands-name>', Console::FG_CYAN) . "\n\n");
        } else {
    ...
    /**
     * Displays the overall information of the commands.
     * @param Controller $controller the controller instance
     */
    protected function getCommandHelp($controller)
    {
        ...
        if (!empty($actions)) {
            ...
            $this->stdout("\n  $scriptName " . $this->ansiFormat('help', Console::FG_YELLOW) . ' '
                            . $this->ansiFormat('<sub-commands>', Console::FG_CYAN) . "\n\n");
        }
    }

    /**
     * Displays the detailed information of a commands action.
     * @param Controller $controller the controller instance
    ...
    protected function getSubCommandHelp($controller, $actionID)
    {
        ...
        if ($action === null) {
            ...
            throw new Exception("No help for unknown sub-commands \"$name\".");
        }
