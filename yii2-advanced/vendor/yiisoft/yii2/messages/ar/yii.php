...
return [
    ...
    'Delete' => 'حذف',
    'Error' => 'خطأ',
    'File uploads failed.' => '.فشل في تحميل الملف',
    'Home' => 'الرئيسية',
    ...
    'No' => 'لا',
    'No help for unknown commands "{commands}".' => 'ليس هناك مساعدة لأمر غير معروف "{commands}".',
    'No help for unknown sub-commands "{commands}".' => 'ليس هناك مساعدة لأمر فرعي غير معروف "{commands}".',
    ...
    'Please uploads a file.' => 'الرجاء تحميل ملف.',
    ...
    'Unknown commands "{commands}".' => 'أمر غير معروف. "{commands}"',
    'Unknown option: --{name}' => 'خيار غير معروف: --{name}',
    'Update' => 'تحديث',
    'View' => 'عرض',
    'Yes' => 'نعم',
    'You are not allowed to perform this action.' => 'غير مصرح لك القيام بهذا العمل',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'تستطيع كأقصى حد تحميل {limit, number} {limit, plural, one{ملف} few{ملفات} many{ملف} other{ملفات}}.',
