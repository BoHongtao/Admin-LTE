...
return [
    ...
    'Delete' => 'Hapus',
    'Error' => 'Kesalahan',
    'File uploads failed.' => 'Mengunggah berkas gagal.',
    'Home' => 'Beranda',
    ...
    'No' => 'Tidak',
    'No help for unknown commands "{commands}".' => 'Tidak ada bantuan untuk perintah yang tidak diketahui "{commands}".',
    'No help for unknown sub-commands "{commands}".' => 'Tidak ada bantuan untuk sub perintah yang tidak diketahui "{commands}".',
    ...
    'Please uploads a file.' => 'Silahkan mengunggah berkas.',
    ...
    'Unknown commands "{commands}".' => 'Perintah tidak dikenal "{commands}".',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Anda dapat mengunggah paling banyak {limit, number} {limit, plural, one{file} other{file}}.',
