...
return [
    ...
    'Delete' => 'Eliminar',
    'Error' => 'Error',
    'File uploads failed.' => 'Ha fallat la pujada del fitxer.',
    'Home' => 'Inici',
    ...
    'No' => 'No',
    'No help for unknown commands "{commands}".' => 'No hi ha ajuda per l\'ordre desconeguda "{commands}"',
    'No help for unknown sub-commands "{commands}".' => 'No hi ha ajuda per la sub-ordre desconeguda "{commands}"',
    ...
    'Please uploads a file.' => 'Si us plau puja un arxiu.',
    ...
    'Unknown commands "{commands}".' => 'Ordre desconeguda "{commands}".',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Pots pujar com a màxim {limit, number} {limit, plural, one{arxiu} other{arxius}}.',
