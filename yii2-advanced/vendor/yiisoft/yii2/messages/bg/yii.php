...
return array (
  ...
  'Delete' => 'Изтрий',
  'Error' => 'Грешка',
  'File uploads failed.' => 'Грешка при качване на файл.',
  'Home' => 'Начало',
  ...
  'No' => 'Не',
  'No help for unknown commands "{commands}".' => 'Няма помощна информация за команда "{commands}".',
  'No help for unknown sub-commands "{commands}".' => 'Няма помощна информация под-команда "{commands}".',
  ...
  'Please uploads a file.' => 'Моля, прикачете файл.',
  ...
  'Unknown commands "{commands}".' => 'Несъществуваща команда "{commands}".',
  ...
  'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Може да прикачите най-много {limit, number} {limit, plural, one{файл} other{файла}}.',
