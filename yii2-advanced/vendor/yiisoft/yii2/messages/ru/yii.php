...
return [
    ...
    'Delete' => 'Удалить',
    'Error' => 'Ошибка',
    'File uploads failed.' => 'Загрузка файла не удалась.',
    'Home' => 'Главная',
    ...
    'Please uploads a file.' => 'Загрузите файл.',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Вы не можете загружать более {limit, number} {limit, plural, one{файла} few{файлов} many{файлов} other{файла}}.',
