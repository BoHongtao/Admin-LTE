...
return [
    ...
    'Delete' => 'Жою',
    'Error' => 'Қате',
    'File uploads failed.' => 'Файлды жүктеу сәтті болмады',
    'Home' => 'Басы',
    ...
    'No' => 'Жоқ',
    'No help for unknown commands "{commands}".' => 'Белгісіз "{commands}" командасы үшін көмек табылмады.',
    'No help for unknown sub-commands "{commands}".' => 'Белгісіз "{commands}" ішкі командасы үшін көмек табылмады.',
    ...
    'Please uploads a file.' => 'Файлды жүктеңіз.',
    ...
    'Unknown commands "{commands}".' => '"{commands}" командасы белгісіз.',
    'Unknown option: --{name}' => 'Белгісіз опция: --{name}',
    'Update' => 'Жаңарту',
    'View' => 'Көру',
    'Yes' => 'Иә',
    'You are not allowed to perform this action.' => 'Сізге бұл әрекетті жасауға рұқсат жоқ',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Сіз {limit} файлдан көп жүктей алмайсыз.',
