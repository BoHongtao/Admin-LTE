 ...
 *
 * This file is automatically generated by 'yii message' commands.
...
return array (
  ...
  'Delete' => 'Kustuta',
  'Error' => 'Viga',
  'File uploads failed.' => 'Faili üleslaadimine ebaõnnestus.',
  'Home' => 'Avaleht',
  ...
  'No' => 'Ei',
  'No help for unknown commands "{commands}".' => 'Abi puudub tundmatu käsu "{commands}" jaoks.',
  'No help for unknown sub-commands "{commands}".' => 'Abi puudub tundmatu alamkäsu "{commands}" jaoks.',
  ...
  'Please uploads a file.' => 'Palun laadige fail üles.',
  ...
  'The file "{file}" is too big. Its size cannot exceed {formattedLimit}.' => 'Fail "{file}" on liiga suur. Suurus ei tohi ületada {formattedLimit}.',
  'The file "{file}" is too small. Its size cannot be smaller than {formattedLimit}.' => 'Fail "{file}" on liiga väike. Suurus ei tohi olla väiksem kui {formattedLimit}.',
  ...
  'Unknown commands "{commands}".' => 'Tundmatu käsklus "{commands}".',
  ...
  'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Saate üles laadida kõige rohkem {limit, number} {limit, plural, one{faili} other{faili}}.',
