...
return [
    ...
    'Delete' => 'Obriši',
    'Error' => 'Greška',
    'File uploads failed.' => 'Postavljanje fajla nije uspelo.',
    'Home' => 'Početna',
    ...
    'No' => 'Ne',
    'No help for unknown commands "{commands}".' => 'Ne postoji pomoć za nepoznatu komandu "{commands}".',
    'No help for unknown sub-commands "{commands}".' => 'Ne postoji pomoć za nepoznatu pod-komandu "{commands}".',
    ...
    'Please uploads a file.' => 'Molimo vas postavite fajl.',
    ...
    'Unknown commands "{commands}".' => 'Nepoznata komanda "{commands}".',
    'Unknown option: --{name}' => 'Nepoznata opcija: --{name}',
    'Update' => 'Ispravi',
    'View' => 'Prikaz',
    'Yes' => 'Da',
    'You are not allowed to perform this action.' => 'Nemate prava da izvršite ovu akciju.',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Možete postaviti najviše {limit, number} {limit, plural, one{fajl} few{fajla} other{fajlova}}.',
