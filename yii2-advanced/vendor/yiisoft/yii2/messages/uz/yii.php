...
return [
    ...
    'Delete' => 'O`chirish',
    'Error' => 'Xato',
    'File uploads failed.' => 'Faylni yuklab bo`lmadi.',
    'Home' => 'Asosiy',
    ...
    'No' => 'Yo`q',
    'No help for unknown commands "{commands}".' => '"{commands}" noaniq komanda uchun ma`lumotnoma mavjud emas.',
    'No help for unknown sub-commands "{commands}".' => '"{commands}" noaniq qism komanda uchun ma`lumotnoma mavjud emas.',
    ...
    'Please uploads a file.' => 'Faylni yuklang.',
    ...
    'Unknown commands "{commands}".' => '"{commands}" noaniq komanda.',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Siz {limit, number} {limit, plural, one{fayldan} few{fayllardan} many{fayllardan} other{fayllardan}} ko`pini yuklab ola olmaysiz.',
