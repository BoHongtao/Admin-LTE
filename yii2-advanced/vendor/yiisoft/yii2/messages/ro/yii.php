...
return [
    ...
    'Delete' => 'Șterge',
    'Error' => 'Eroare',
    'File uploads failed.' => 'Încărcarea fișierului a eșuat.',
    'Home' => 'Acasă',
    ...
    'No' => 'Nu',
    'No help for unknown commands "{commands}".' => 'Nu sunt referințe pentru comanda necunoscută "{commands}".',
    'No help for unknown sub-commands "{commands}".' => 'Nu sunt referințe pentru sub-comanda necunoscută "{commands}".',
    ...
    'Please uploads a file.' => 'Vă rugăm sa încărcați un fișier.',
    ...
    'Unknown commands "{commands}".' => 'Comandă necunoscută "{commands}".',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Puteți încărca maxim {limit, number} {limit, plural, one{fișier} other{fișiere}}.',
