...
return [
    ...
    'Delete' => 'Sil',
    'Error' => 'Xəta',
    'File uploads failed.' => 'Fayl yüklənmədi.',
    'Home' => 'Ana səhifə',
    ...
    'No' => 'Xeyr',
    'No help for unknown commands "{commands}".' => 'Qeyri-müəyyən "{commands}" əmri üçün kömək yoxdur.',
    'No help for unknown sub-commands "{commands}".' => 'Qeyri-müəyyən "{commands}" sub-əmri üçün kömək yoxdur.',
    ...
    'Please uploads a file.' => 'Xahiş olunur bir fayl yükləyin.',
    ...
    'Unknown commands "{commands}".' => 'Qeyri-müəyyən əmr "{commands}".',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Ancaq {limit, number} {limit, plural, one{fayl} other{fayl}} yükləyə bilərsiniz.',
