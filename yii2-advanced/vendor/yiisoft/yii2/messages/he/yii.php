...
return [
    ...
    'Delete' => 'מחק',
    'Error' => 'שגיאה',
    'File uploads failed.' => 'העלאת קובץ נכשלה',
    'Home' => 'דף הבית',
    ...
    'No' => 'לא',
    'No help for unknown commands "{commands}".' => 'פקודה "{commands}" לא מוכרת ואין לה עזרה',
    'No help for unknown sub-commands "{commands}".' => 'תת-פקודה "{commands}" לא מוכרת ואין לה עזרה',
    ...
    'Please uploads a file.' => 'נא העלה קובץ.',
    ...
    'Unknown commands "{commands}".' => 'Unknown commands "{commands}".',
    'Unknown option: --{name}' => 'Unknown option: --{name}',
    'Update' => 'עדכון',
    'View' => 'תצוגה',
    'Yes' => 'כן',
    'You are not allowed to perform this action.' => 'אינך מורשה לבצע את הפעולה הזו.',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'אתה יכול להעלות לכל היותר {limit, number} {limit, plural, one{קובץ} few{קבצים} many{קבצים} other{קבצים}}.',
