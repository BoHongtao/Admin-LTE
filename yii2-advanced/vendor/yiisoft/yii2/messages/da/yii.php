...
return array (
  ...
  'Delete' => 'Slet',
  'Error' => 'Fejl',
  'File uploads failed.' => 'Upload af fil fejlede.',
  'Home' => 'Start',
  ...
  'No' => 'Nej',
  'No help for unknown commands "{commands}".' => 'Ingen hjælp til ukendt kommando "{commands}".',
  'No help for unknown sub-commands "{commands}".' => 'Ingen hjælp til ukendt under-kommando "{commands}".',
  ...
  'Please uploads a file.' => 'Venligst uploads en fil.',
  ...
  'Unknown commands "{commands}".' => 'Ukendt kommando "{commands}".',
  ...
  'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Du kan højst uploade {limit, number} {limit, plural, one{fil} other{filer}}.',
