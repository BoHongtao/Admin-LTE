...
return [
    ...
    'Delete' => 'Obrisati',
    'Error' => 'Pogreška',
    'File uploads failed.' => 'Upload podatka nije uspio.',
    'Home' => 'Home',
    ...
    'No' => 'Ne',
    'No help for unknown commands "{commands}".' => 'Nema pomoći za nepoznatu naredbu "{commands}"',
    'No help for unknown sub-commands "{commands}".' => 'Nema pomoći za nepoznatu pod-naredbu "{commands}"',
    ...
    'Please uploads a file.' => 'Molimo vas da uploadate datoteku.',
    ...
    'Unknown commands "{commands}".' => 'Nepoznata naredba "{commands}".',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Najviše možete uploadat {limit, number} {limit, plural, one{fajl} other{fajlova}}.',
