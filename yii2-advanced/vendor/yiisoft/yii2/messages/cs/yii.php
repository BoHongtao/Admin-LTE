...
return [
    ...
    'Delete' => 'Smazat',
    'Error' => 'Chyba',
    'File uploads failed.' => 'Nepodařilo se nahrát soubor.',
    'Home' => 'Úvod',
    ...
    'No' => 'Ne',
    'No help for unknown commands "{commands}".' => 'K neznámému příkazu "{commands}" neexistuje nápověda.',
    'No help for unknown sub-commands "{commands}".' => 'K neznámému pod-příkazu "{commands}" neexistuje nápověda.',
    ...
    'Please uploads a file.' => 'Nahrajte prosím soubor.',
    ...
    'Unknown commands "{commands}".' => 'Neznámý příkaz "{commands}".',
    'Unknown option: --{name}' => 'Neznámá volba: --{name}',
    'Update' => 'Upravit',
    'View' => 'Náhled',
    'Yes' => 'Ano',
    'You are not allowed to perform this action.' => 'Nemáte oprávnění pro požadovanou akci.',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Nahrát můžete nanejvýš {limit, number} {limit, plural, one{soubor} few{soubory} other{souborů}}.',
