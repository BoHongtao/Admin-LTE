...
return [
    ...
    'No' => '否',
    'No help for unknown commands "{commands}".' => '子命令 "{commands}" 發生未知的錯誤。',
    'No help for unknown sub-commands "{commands}".' => '子命令 "{commands}" 發生未知的錯誤。',
    ...
    'Unknown commands "{commands}".' => '未知的指令 "{commands}"。',
    'Unknown option: --{name}' => '未知的選項：--{name}',
    'Update' => '更新',
    'View' => '查看',
    'Yes' => '是',
    'You are not allowed to perform this action.' => '您沒有執行此操作的權限。',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => '您最多可以上載 {limit, number} 個檔案。',
    'the input value' => '該輸入',
