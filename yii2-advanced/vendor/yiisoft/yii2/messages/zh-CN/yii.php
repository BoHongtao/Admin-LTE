...
return [
    ...
    'No' => '否',
    'No help for unknown commands "{commands}".' => '命令"{commands}"发生未知的错误。',
    'No help for unknown sub-commands "{commands}".' => '子命令"{commands}"发生未知的错误。',
    ...
    'Unknown commands "{commands}".' => '未知的命令 "{commands}"。',
    'Unknown option: --{name}' => '未知的选项：--{name}',
    'Update' => '更新',
    'View' => '查看',
    'Yes' => '是',
    'You are not allowed to perform this action.' => '您没有执行此操作的权限。',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => '您最多上传{limit, number}个文件。',
    'the input value' => '该输入',
