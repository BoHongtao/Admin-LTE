...
return [
    ...
    'Delete' => 'Izbrišite',
    'Error' => 'Napaka',
    'File uploads failed.' => 'Nalaganje datoteke ni bilo uspešno.',
    'Home' => 'Domov',
    ...
    'No' => 'Ne',
    'No help for unknown commands "{commands}".' => 'Pomoči za neznani ukaz "{commands}" ni mogoče najti.',
    'No help for unknown sub-commands "{commands}".' => 'Pomoči za neznani pod-ukaz "{commands}" ni mogoče najti.',
    ...
    'Please uploads a file.' => 'Prosimo, naložite datoteko.',
    ...
    'Unknown commands "{commands}".' => 'Neznani ukaz "{commands}".',
    'Unknown option: --{name}' => 'Neznana opcija: --{name}',
    'Update' => 'Posodobitev',
    'View' => 'Pogled',
    'Yes' => 'Da',
    'You are not allowed to perform this action.' => 'Ta akcija ni dovoljena za izvajanje.',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Naložite lahko največ {limit, number} {limit, plural, one{datoteko} two{datoteki} few{datoteke} other{datotek}}.',
