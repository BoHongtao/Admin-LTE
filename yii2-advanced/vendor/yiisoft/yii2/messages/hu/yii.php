...
return array (
  ...
  'Delete' => 'Törlés',
  'Error' => 'Hiba',
  'File uploads failed.' => 'A fájlfeltöltés nem sikerült.',
  'Home' => 'Főoldal',
  ...
  'No' => 'Nem',
  'No help for unknown commands "{commands}".' => 'Nincs súgó az ismeretlen {commands} parancshoz.',
  'No help for unknown sub-commands "{commands}".' => 'Nincs súgó az ismeretlen {commands} alparancshoz.',
  ...
  'Please uploads a file.' => 'Kérjük töltsön fel egy fájlt.',
  ...
  'Unknown commands "{commands}".' => 'Ismeretlen parancs: "{commands}".',
  ...
  'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Legfeljebb {limit, number} fájlt tölthet fel.',
