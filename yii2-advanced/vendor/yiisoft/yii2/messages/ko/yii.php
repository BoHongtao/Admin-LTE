...
return [
    ...
    'Delete' => '삭제',
    'Error' => '오류',
    'File uploads failed.' => '파일 업로드 실패하였습니다.',
    'Home' => '홈',
    ...
    'No' => '아니오',
    'No help for unknown commands "{commands}".' => '알 수 없는 명령 "{commands}"에 대한 도움말이 없습니다.',
    'No help for unknown sub-commands "{commands}".' => '알 수 없는 하위명령  "{commands}"에 대한 도움말이 없습니다.',
    ...
    'Please uploads a file.' => '파일을 업로드하십시오.',
    ...
    'Unknown commands "{commands}".' => '알 수 없는 명령 "{commands}".',
    'Unknown option: --{name}' => '알 수 없는 옵션: --{name}',
    'Update' => '갱신',
    'View' => '보기',
    'Yes' => '예',
    'You are not allowed to perform this action.' => '이 작업의 실행을 허가받지못하였습니다.',
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => '최대 {limit} 개의 파일을 업로드할 수 있습니다.',
