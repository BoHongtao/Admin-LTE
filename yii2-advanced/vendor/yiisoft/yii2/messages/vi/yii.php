...
return [
    ...
    'Delete' => 'Xóa',
    'Error' => 'Lỗi',
    'File uploads failed.' => 'Không tải được file lên.',
    'Home' => 'Trang chủ',
    ...
    'No' => 'Không',
    'No help for unknown commands "{commands}".' => 'Không có trợ giúp cho lệnh không rõ "{commands}"',
    'No help for unknown sub-commands "{commands}".' => 'Không có trợ giúp cho tiểu lệnh không rõ "{commands}"',
    ...
    'Please uploads a file.' => 'Hãy tải file lên.',
    ...
    'Unknown commands "{commands}".' => 'Lệnh không biết "{commands}"',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Chỉ có thể tải lên tối đa {limit, number} file.',
