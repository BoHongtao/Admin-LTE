 ...
 *
 * This file is automatically generated by 'yii message/extract' commands.
...
return [
    ...
    'Delete' => 'Διαγραφή',
    'Error' => 'Σφάλμα',
    'File uploads failed.' => 'Το ανέβασμα του αρχείου απέτυχε.',
    'Home' => 'Αρχική',
    ...
    'Please uploads a file.' => 'Παρακαλώ ανεβάστε ένα αρχείο.',
    ...
    'You can uploads at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Μπορείτε να ανεβάσετε το πολύ {limit, number} {limit, plural, one{αρχείο} few{αρχεία} many{αρχεία} other{αρχεία}}.',
