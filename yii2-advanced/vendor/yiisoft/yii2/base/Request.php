...
abstract class Request extends Component
{
    ...
    /**
     * Returns a value indicating whether the current request is made via commands line
    ...
    /**
     * Sets the value indicating whether the current request is made via commands line
     * @param boolean $value the value indicating whether the current request is made via commands line
     */
