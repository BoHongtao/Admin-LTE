 ...
 * then the themed version for a view file `@app/views/site/mobile-index.php` will be
 * `@app/themes/basic/site/mobile-index.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/mobile-index.php` or
 * `@app/themes/basic/site/mobile-index.php`. The former has precedence over the latter if both files exist.
 *
