...
/**
 * This commands creates fixtures based on a given template.
 *
 ...
 * This commands is a simple wrapper for the [Faker](https://github.com/fzaninotto/Faker) library.
 *
 ...
 * ~~~
 *
 * To start using the commands you need to be familiar (read guide) with the Faker library and
 ...
 *
 * After you prepared needed templates for tables you can simply generate your fixtures via commands
 *
 * ~~~
 ...
 * ~~~
 *
 * In the code above "users" is template name, after this commands run, new file named same as template
 ...
 * ~~~
 *
 * This commands will generate fixtures for all template files that are stored under $templatePath and
 ...
 * ~~~
 *
 * You can specify different options of this commands:
 *
 * ~~~
 ...
 * ~~~
 *
 * You can see all available templates by running commands:
 *
 * ~~~
 ...
 * ~~~
 *
 * you can use it by adding it to the $providers property of the current commands. In your console.php config:
 *
 * ~~~
 *    'controllerMap' => [
 *        'fixture' => [
